...
import { countryValidation, emailValidation, passwordValidation, phoneNumberValidation, userNameValidation } from "../Validator/Validator";
...
function Register() {
  ...
  const [showComfirmPassword,setShowConfirmPassword]=useState(true);
 ...
 const appendToFormData = (values:any) =>{
          ...
          >
           ...
           <div className={`${styles.upload} mx-auto  my-3 d-flex flex-wrap justify-content-center align-items-center `}>
            ...
            <div className={`${styles.round} text-center  d-flex align-items-end  text-center justify-content-center mx-auto `}>
                 <input
                  onChangeCapture={(e)=>handlePicture(e)}
           ...
           <div className="d-flex flex-wrap align-items-start     mt-2 ">
            ...
            <div className=" one-input-group       col-md-6 pe-lg-5 pe-md-3   my-2  col-12">
              ...
              {errors?.country && (
                <p className="text-danger">{String(errors?.country?.message)}</p>
              )}
            </div>
            ...
            <div className=" one-input-group       col-md-6 ps-lg-5 ps-md-3   my-2 col-12">
              ...
              {errors?.phoneNumber && (
                <p className="  text-danger">{String(errors?.phoneNumber?.message)}</p>
              )}
            </div>
            <div className=" one-input-group       col-md-6 pe-lg-5 pe-md-3   my-2 col-12">
              <div className="form-outline position-relative text-start d-flex flex-wrap">
            ...
            <button
              type="submit"
              className={`btn btn-warning text-center  text-white  rounded-5 mb-2 ${
                isLoading ? "noClick" : ""
              }`}
            >
              {isLoading ? <Loading components={false} /> : "Register"}
            </button>
          </div>   
          </div>
          </form>
